...
/**
 * Extension of the {@link ImageGalleryFragment}. Needed to get the {@link EditThesisViewModel}.
 */
public class ImageGalleryEditThesisFragment extends ImageGalleryFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        EditThesisViewModel viewModel = new ViewModelProvider(requireActivity()).get(EditThesisViewModel.class);
