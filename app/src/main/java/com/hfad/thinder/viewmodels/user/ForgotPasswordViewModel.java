...
public class ForgotPasswordViewModel extends ViewModel {
    ...
    public void login() {
        ...
        if (result.getSuccess()) {
            if (userRepository.getType() == USERTYPE.STUDENT) {
                loginResult.setValue(new ViewModelResult(result.getErrorMessage(), ViewModelResultTypes.STUDENT));
            } else if (userRepository.getType() == USERTYPE.SUPERVISOR) {
                loginResult.setValue(new ViewModelResult(result.getErrorMessage(), ViewModelResultTypes.SUPERVISOR));
            }
        } else {
            loginResult.setValue(new ViewModelResult(result.getErrorMessage(), ViewModelResultTypes.ERROR));
        }
    }
    ...
    private Integer passwordConfirmationFormIsValid() {
        if (newPasswordConfirmation.getValue() == null || newPasswordConfirmation.getValue().equals("")) {
