...
public class EditProfileViewModel extends ViewModel {
    ...
    public void safe() {
        ...
        if (result.getSuccess()) {
            ...
            safeResult.setValue(new ViewModelResult(result.getErrorMessage(), ViewModelResultTypes.ERROR));
        }
    ...
    public void delete() {
        ...
        if (result.getSuccess()) {
            deleteResult.setValue(new ViewModelResult(result.getErrorMessage(), ViewModelResultTypes.SUCCESSFUL));
        } else {
            deleteResult.setValue(new ViewModelResult(result.getErrorMessage(), ViewModelResultTypes.ERROR));
        }
    }
